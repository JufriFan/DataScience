...
@app.callback(
    ...
    Input(component_id='site-dropdown', component_property='value') # Revise: Removed the payload-slider input.
)
...
@app.callback(
    ...
    [Input(component_id='site-dropdown', component_property='value'),
     Input(component_id='payload-slider', component_property='value')] #Revise: added the input in the list format.
)
